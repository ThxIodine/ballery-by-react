...
import imageDatas from '../data/image_data.json'
import ImgFigure from './img_figure.jsx';
import ControllerUnit from './controller_unit.jsx';

export default class GalleryByReact extends React.Component{
	/*
	 *重新布局所有图片
	...
	render(){
		...
		const controllerUnits = imageDatas.map((value,index)=>(
